  ...
  return (
    <div className="flex h-screen bg-[#F6F5EE] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <DashboardNavbar displayName={displayName} initials={initials} role={profile?.role ?? 'counselor'} />
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 bg-[#F6F5EE]">
          {children}
        </main>
      </div>
    </div>
